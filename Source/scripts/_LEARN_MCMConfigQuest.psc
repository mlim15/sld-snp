...
Event OnOptionHighlight(int option)
	...
	ElseIf (Option == studyRequiresNotesOID)
		setInfoText(__l("hint_study_requires_notes", "Whether or not using the 'Study' power requires having notes in the inventory. Defaults to off."))
	ElseIf (Option == removeSpellsOID)
    ...
    ElseIf (Option == addToListOID)
        setInfoText(__l("hint_add_to_list", "Whether or not unknown spells are added to the research list when a spell tome is consumed. If you only want to use this mod's spell discovery features, turn this off. Defaults to on."))
    ElseIf (Option == returnTomesOID)
