...
Event OnOptionHighlight(int option)
	...
	ElseIf (Option == dreadstareLethalityOID)
        SetInfoText(__l("hint_dreadstareLethality", "The percent chance to be killed when consuming Dreadmilk while addicted. Shadowmilk is 1/4 as lethal. Default is 10%. Also increases by your bloodstream toxicity, which increases 10% every time you consume Dreadmilk and decreases over time."))
