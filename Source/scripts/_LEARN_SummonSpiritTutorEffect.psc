...
Event OnEffectStart(Actor Target, Actor Caster)
	...
	if (fRand > 0.95)
		...
		if (!PlayerRef.HasSpell(Dreadstare))
			...
			Debug.Notification(__l("tutor_need more sudden", "You suddenly feel an excruciating yearning for Dreadmilk..."))
		endIf
	...
	elseIf (fRand > 0.9)
		...
		Debug.Notification(__l("tutor_forgot spell", "You've forgotten something... but what?"))
	elseIf (fRand > 0.8)
		; lose gold
		PlayerRef.removeitem(Game.getform(0xF), 500)
		Debug.Notification(__l("tutor_lost money", "Your pockets suddenly feel lighter."))
	elseIf (fRand > 0.6)
		; reduce max destro and resto for 1 in-game day
		TutorPrice02.Cast(PlayerRef, PlayerRef)
		Debug.Notification(__l("tutor_drained", "You suddenly feel very drained..."))
	elseIf (fRand > 0.4)
		; reduce max health and magicka for 1 in-game day
		TutorPrice01.Cast(PlayerRef, PlayerRef)
		Debug.Notification(__l("tutor_weaker", "You suddenly feel very tired..."))
	endIf
